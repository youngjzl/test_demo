...
class Export_EweiShopV2Page extends WebPage 
{
	...
	protected function defaultColumns() 
	{
		return array(
			...
			array('title' => '会员id(订购人注册号)', 'field' => 'uid', 'width' => 12),
			array('title' => '会员等级', 'field' => 'level', 'width' => 12),
			array('title' => '会员姓名(订购人姓名)', 'field' => 'mrealname', 'width' => 12),
			array('title' => '会员手机号(订购人电话)', 'field' => 'mmobile', 'width' => 12),
			array('title' => '自提门店', 'field' => 'pickname', 'width' => 24),
			array('title' => '自提码', 'field' => 'verifycode', 'width' => 24),
			array('title' => 'openid', 'field' => 'openid', 'width' => 24),
			array('title' => '收货人姓名(或自提人)', 'field' => 'realname', 'width' => 12),
			...
			array('title' => '支付方式(支付企业名称)', 'field' => 'paytype', 'width' => 12),
			array('title' => '支付交易编号', 'field' => 'transid', 'width' => 36),
			array('title' => '配送方式', 'field' => 'dispatchname', 'width' => 12),
			array('title' => '商品小计(含税费)', 'field' => 'goodsprice', 'width' => 12),
			array('title' => '运费(运杂费)', 'field' => 'dispatchprice', 'width' => 12),
			array('title' => '积分抵扣(非现金抵扣金额)', 'field' => 'deductprice', 'width' => 12),
			...
			array('title' => '应收款(实际支付金额)', 'field' => 'price', 'width' => 12),
			...
			array('title' => '核销门店', 'field' => 'storeinfo', 'width' => 36), array('title' => '订单自定义信息', 'field' => 'order_diyformdata', 'width' => 36),
			...
			array('title' => "证件类型(订购人证件类型)", "field" => "idcard_type", "width" => 36 ),
			array('title' => "身份证号码(订购人证件号码)", "field" => "idnumber", "width" => 36 ),
			array('title' => "身份证正面", "field" => "idcard_front", "width" => 36 ),
			array('title' => "身份证反面", "field" => "idcard_back", "width" => 36 ),
			array('title' => "商品小计(不含税费)(代扣税款)", "field" => "goods_price", "width" => 36 ),
			array('title' => "税费(代扣税款)", "field" => "retaprice", "width" => 36 ),
			array('title' => "电商企业名称", "field" => "company", "width" => 36 ),
			array('title' => "收货地址行政区域代码", "field" => "area_code", "width" => 36 ),
			array('title' => "发货人", "field" => "shipper", "width" => 36 ),
			array('title' => "发货人电话", "field" => "shipper_tel", "width" => 36 ),
			array('title' => "发货人地址", "field" => "shipper_address", "width" => 36 ),
			array('title' => "发货人所在国", "field" => "shipper_country", "width" => 36 ),
			array('title' => "贸易国别", "field" => "trade_country", "width" => 36 ),
			array('title' => "备注", "field" => "remark", "width" => 36 ),

            array('title' => "系统编号", "field" => "xinzeng_bdid", "width" => 12 ),
            array('title' => "商户海关备案号", "field" => "xinzeng_hgbah", "width" => 24 ),
            array('title' => "上报海关", "field" => "xinzeng_sbhg", "width" => 12 ),
            array('title' => "公众平台名称", "field" => "xinzeng_gzptmc", "width" => 12 ),
            array('title' => "电商平台名称", "field" => "xinzeng_dsptmc", "width" => 24 ),
            array('title' => "商城序号", "field" => "xinzeng_scxh", "width" => 12 )
        );
	}
		...
		if ($_GPC['export'] == 1) 
		{
			...
			if ($goodsindex != -1) 
			{
				array_splice($columns, $goodsindex + 1, 0, array(
					array('title' => "商品序号", "field" => "retaprice", "width" => 36 ),
					array('title' => "企业商品货号", "field" => "goods_goodssn", "width" => 36 ),
					array('title' => "企业商品规格型号", "field" => "goods_optiontitle", "width" => 36 ),
					array('title' => "企业商品描述", "field" => "goods_optiontitle", "width" => 36 ),
					...
					array('title' => '原产国', 'field' => 'goods_productsn', 'width' => 12),
					array('title' => '商品国检备案号', 'field' => 'goods_optiontitle', 'width' => 12),
					array('title' => '包装种类代码(国检)', 'field' => 'goods_total', 'width' => 12)
				));
			}
			...
			if (!(empty($_GPC['time']['start'])) && !(empty($_GPC['time']['end']))) 
			{
				...
				$endtime = strtotime($_GPC['time']['end'])+59;//前端少了59秒
			...
			foreach ($list as &$value ) 
			{
				...
				/*税费和商品小计*/
				$value["goodsprice"] = $goodsprice;
				$value["rateprice"] = $rate_price;

                $value["xinzeng_bdid"]=++$excel_id;
                $value["xinzeng_hgbah"]='3502160D78';
                $value["xinzeng_sbhg"]='GUANGZHOU_ZS';
                $value["xinzeng_gzptmc"]='优铼优购';
                $value["xinzeng_dsptmc"]='厦门优铼电子商务有限公司';
                $value["xinzeng_scxh"]='1';
			...
			if ($this->field_index($columns, 'goods_title') != -1) 
			{
				...
				foreach ($list as $index => $r ) 
				{
					...
					foreach ($r['goods'] as $g ) 
					{
						...
						// $exportlist['row' . $goodsindex]['goodsbusinesstype']  = $g['goodsbusinesstype'];

						switch($g['goodsbusinesstype']) {
							case '1':
								$goodsbusinesstype  = '普通商品';
								break;
							case '2':
								$goodsbusinesstype  = '保税商品';
								break;
							case '3':
								$goodsbusinesstype  = '海外直邮';
								break;
							case '4':
								$goodsbusinesstype  = '完税商品';
								break;
							case '5':
								$goodsbusinesstype  = '个人物品';
								break;
							default: 
								$goodsbusinesstype  = '';
						}
						$exportlist['row' . $goodsindex]['goodsbusinesstype'] = $goodsbusinesstype;
