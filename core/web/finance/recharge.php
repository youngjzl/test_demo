	...
	public function main()
	{
		...
		if ($_W['ispost']) {
			...
			if ($type == 'credit2') {
				...
				$data = array('openid' => $profile['openid'], 'logno' => $logno, 'uniacid' => $_W['uniacid'], 'type' => '0', 'createtime' => TIMESTAMP, 'status' => '1', 'title' => $set['name'] . '会员充值', 'money' => $num, 'remark' => $remark, 'rechargetype' => 'system','operator'=>$_W['uid'],'operator_ip'=>CLIENT_IP);
