var baseurl = "/addons/ewei_shopv2/static/js/app";
var version = (new Date()).getTime();
define(['core', 'tpl', baseurl + '/biz/goods/picker.js?r=' + version, baseurl + '/biz/goods/wholesalePicker.js?r=' + version], function(core, tpl, picker, wholesalePicker) {
    var defaults = {
        keywords: '',
        isrecommand: '',
        ishot: '',
    ...
    modal.init = function(params) {
        ...
        if (modal.oldkeywords) {
            modal.params.keywords = modal.oldkeywords
        }
    ...
    modal.bindEvents = function() {
        $('.buy').unbind('click').click(function() {
            var isnewuser=$(this).parent('.price').attr('isnewuser')
            if (isnewuser==0){
                FoxUI.alert("您是优铼老司机啦<br/>【邀请新人】帮您下单吧")
                return false;
            }
