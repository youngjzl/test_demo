    ...
    modal.getNavs = function () {
        modal.navs = {
            ...
            picture: {
                name: '单图组',
                params: {},
                style: {'paddingtop': '0', 'paddingleft': '0','achosel':'0'},
                data: {
                    C0123456789101: {
                        imgurl: '../addons/ewei_shopv2/plugin/diypage/static/images/default/banner-1.jpg',
                        linkurl: '',
            ...
            $("#diy-editor .slider").each(function () {
                ...
                $(this).slider({
                    slide: function (event, ui) {
                        ...
                        // 监听图标的大小add qdy
                        if($(this).next('.count').hasClass('slideval')){//判断是否含有slideval类名才执行默认效果
                            if($(this).children('.logosize') && sliderValue==47){
                                $(this).siblings(".logosize").find("span").text(sliderValue+'px(默认)')
                            }else if($(this).children('.logosize') && sliderValue!=47){
                                $(this).siblings(".logosize").find("span").text(sliderValue+'px')
                            }else{
                                $(this).siblings(".logosize").find("span").text(sliderValue)
                            }
                            if($(this).children('.logomargin') && sliderValue==2){
                                $(this).siblings(".logomargin").find("span").text(sliderValue+'px(默认)')
                            }else if($(this).children('.logomargin') && sliderValue!=2){
                                $(this).siblings(".logomargin").find("span").text(sliderValue+'px')
                            }else{
                                $(this).siblings(".logomargin").find("span").text(sliderValue)
                            }
                        }else{
