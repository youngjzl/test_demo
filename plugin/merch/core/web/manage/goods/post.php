...
//$category = pdo_fetchall('select id,name,thumb from ' . tablename('ewei_shop_creditshop_category') . ' where uniacid=:uniacid and ismerchid='.$_W['merchid'].' order by displayorder desc', array(':uniacid' => $_W['uniacid']));
...
if ($_W['ispost']) {
	...
	$data = array(
		...
		'goodsbusinesstype' => intval($_GPC['goodsbusinesstype'])
	);
